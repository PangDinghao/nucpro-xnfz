      ...
      <template>
        <div style="margin: 20px;width: 100%;text-align: center">
          <div style="display: flex; align-items: center; justify-content: space-between;">
            <el-page-header @back="ReturnToTeacherProUserManage" content="班级管理" style="width: 200px;"></el-page-header>
...
export default {
  ...
  methods:{
    ...
    ReturnToTeacherProUserManage(){
      this.$router.push("Class_TeacherProUser");
    }
  },
  computed: {
    beforeMount() {
